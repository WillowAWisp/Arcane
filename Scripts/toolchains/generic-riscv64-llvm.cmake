...
set(CMAKE_C_FLAGS "--target=riscv64 -march=rv64if -std=c17" CACHE INTERNAL "")
set(CMAKE_CXX_FLAGS "--target=riscv64 -march=rv64if -std=c++20" CACHE INTERNAL "")
set(CMAKE_ASM_FLAGS "--target=riscv64 -march=rv64if" CACHE INTERNAL "")
